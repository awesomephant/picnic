  ...
  handleMouseUp(e) {
    ...
    if (this.state.settings.currentTool === "img") {
      ...
      obj = {
        ...
        lineHeight: 1.1,
        letterSpacing: 0,
        text: "This paragraph of text is very very long",
        x: this.state.placeholder.x + 1,
        y: this.state.placeholder.y,
        w: this.state.placeholder.w,
        h: this.state.placeholder.h,
      }
